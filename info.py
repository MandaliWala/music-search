...
PICS = (environ.get('PICS', 'https://envs.sh/r2r.jpg')).split() #SAMPLE PIC
START_IMG = environ.get('START_IMG', 'https://envs.sh/r2r.jpg')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002556071769').split()]
